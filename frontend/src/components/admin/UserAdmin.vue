  ...
  <div class="user-admin">
      <b-form>
          ...
          <b-form-checkbox id="user-admin" v-model="user.admin" class="mt-3 mb-3"  v-show="mode === 'save' ">
            ...
            <b-col md="6" sm="12">
                  <b-form-group label="Nome:" label-for="user-password">
                      <b-form-input id="user-password" type="password"
                        v-model="user.password" require
              ...
              <b-col md="6" sm="12">
                  <b-form-group label="Confirmação de senha:" label-for="user-confirmPassword">
                      <b-form-input id="user-confirmPassword" type="password"
                        v-model="user.confirmPassword" require
